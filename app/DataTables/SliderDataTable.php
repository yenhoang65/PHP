    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $deleteBtn = "<a href='".route('admin.slider.destroy',$query->id)."' class='btn btn-danger ml-3 delete-item'><i class='far fa-trash-alt'></i></a>";
            ...
            ->addColumn('status',function($query){
                ...
                $inActive ='<i class = "badge badge-info">Inactive</i>';
                if($query->status == 1){
                    return $active;
                }else{
                    return $inActive;
