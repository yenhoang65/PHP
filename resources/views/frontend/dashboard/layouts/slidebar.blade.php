<div class="dashboard_sidebar">
    ...
    {{-- <a href="dsahboard.html" class="dash_logo"><img src="{{ asset('frontend/images/logo3.jpg') }}" alt="logo" class="img-fluid"></a> --}}
    <ul class="dashboard_link">
        <li><a class="active" href="{{route('user.dashboard')}}"><i class="fas fa-tachometer"></i>Dashboard</a></li>
        <li><a href="{{route('home')}}"><i class="fas fa-list-ul"></i> Home</a></li>
