            ...
            <div class="row">
                                    ...
                                    @foreach ($cartItems as $item)
                                        <tr class="d-flex">
                                            ...
                                            <td class="wsus__pro_tk">
                                                <h6>{{ number_format($item->price ). $settings->currency_icon }}</h6>
                                            </td>
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        <h6>total cart</h6>
                        <p>subtotal: <span id="sub_total">{{ number_format(getCartTotal()) }} {{ $settings->currency_icon }} </span></p>
                        <p>coupon(-): <span id="discount">  {{ number_format(getCartDiscount()) }} {{ $settings->currency_icon }}</span>
                        </p>
