                    ...
                    for (let item in data) {
                        ...
                        <li id="mini_cart_${product.rowId}">
                            <div class="wsus__cart_img">
                                <a href="{{ url('product-details') }}/${product.options.slug}"><img src="{{ asset('/') }}${product.options.image}" alt="product"
                            ...
                            <div class="wsus__cart_text">
                                ...
                                <small>
                            Variants
                            total:${product.options.variants_total}{{ $settings->currency_icon }}</small>
                            <br>
