                ...
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        @foreach ($categories as $category)
                            <li><a class="wsus__droap_arrow" href="{{route('products.index',['category'=> $category->slug])}}"><i class="{{$category->icon}}"></i>{{$category->name}}</a>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        {{-- <li><a href="{{ route('login') }}">login</a> --}}
                            @if (Auth::check())
                                <li><a style="font-weight: 600" href="{{ route('user.dashboard') }}">{{auth()->user()->name}}</a></li>
                            @else
