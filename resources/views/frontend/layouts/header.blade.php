<header>
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <a class="wsus__header_logo" href="{{ route('home') }}">
                        <img src="{{ asset('frontend/images/logot2.jpg') }}" alt="logo" class="img-fluid w-100">
                    </a>
                </div>
            </div>
    ...
    <div class="wsus__mini_cart">
            ...
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{ $sidebarProduct->rowId }}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <p>{{ number_format($sidebarProduct->price) }} {{ $settings->currency_icon }}</p>
                        <small>
                            Variants
                            total:{{ $sidebarProduct->options->variant_total }} {{ $settings->currency_icon }}</small>
                        <br>
        ...
        <div class="mini_cart_actions {{ Cart::content()->count() === 0 ? 'd-none' : '' }}">
            <h5>sub total <span id="mini_cart_subtotal">{{ number_format(getCartTotal()) }} {{ $settings->currency_icon }}</span></h5>
