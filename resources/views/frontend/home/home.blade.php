...
@section('content')
    ...
    ==============================-->
        {{-- @include('frontend.home.sections.top-cate-product') --}}
    <!--============================
    ...
    <!--============================
        HOT DEALS START
    ==============================-->
        @include('frontend.home.sections.hot-deadls')
    <!--============================
        HOT DEALS END
    ==============================-->
    ...
    <!--============================
        LARGE BANNER  START
    ==============================-->
        @include('frontend.home.sections.lagrge-banner')
    <!--============================
        LARGE BANNER  END
    ==============================-->
