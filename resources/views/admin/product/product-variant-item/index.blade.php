            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{route('admin.products-variant-item.create',['variantId'=>$variant->id,'productId'=>$product->id])}}" class="btn btn-primary">+ Create new</a>
                </div>
              </div>
              <div class="card-body">
                {{$dataTable->table()}}
...
@push('scrips')
    ...
    <script>
        $(document).ready(function(){
            $('body').on('click','.changes-status',function(){
